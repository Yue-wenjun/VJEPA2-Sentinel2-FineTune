...
from src.models.utils.doy_encoding import DOYEncoding
...
class VisionTransformer(nn.Module):
    ...
    def forward(self, x, masks=None, training=False, doys=None):
        """
        ...
        if self.doy_encoding is not None and doys is not None and H_patches is not None:
            n_spatial = H_patches * W_patches
            x += self.doy_encoding(doys, self.tubelet_size, n_spatial)
